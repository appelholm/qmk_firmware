...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    [_US] = LAYOUT_planck_mit(
        ...
        KC_LCTL, KC_LGUI, KC_CAPS, KC_LALT, MO(_FN2), KC_SPC, LT(_FN1, KC_ENT),
    ...
    [_FN1] = LAYOUT_planck_mit(
        ...
        _______, KC_HASH, KC_DOLLAR, KC_LPRN, KC_RPRN, _______, KC_PLUS, KC_4,
    ...
    [_FN2] = LAYOUT_planck_mit(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_LEFT,
        KC_DOWN,  KC_UP, KC_RIGHT, _______,

        _______, _______, _______, _______, _______, _______, _______, KC_HOME,
        KC_PGDN, KC_PGUP, KC_END, _______,

        _______, _______, _______, TG(_SE), _______, _______, _______, _______,
        _______, _______, _______
    )
};
