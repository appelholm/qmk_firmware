...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
     ...
     * |---------------------------------------------------------------------------------------+
     * |ML(SYS)|ML(FN2)| Alt |               Space               |T(SE)| Left| Down|  Up |Right|
     * '---------------------------------------------------------------------------------------'
     */
    [_US] = LAYOUT(
        ...
        MO(_SYS), MO(_FN2), KC_LALT, KC_SPC, KC_SPC, KC_SPC, TG(_SE), KC_LEFT,
    ...
    [_FN1] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, PMEMBER, _______, _______, _______,
    ...
    [_SYS] = LAYOUT(
        ...
        _______, KC_LGUI, _______, _______, _______, _______, KC_PWR, _______,
        _______, _______, LGUI(KC_L)),
};
